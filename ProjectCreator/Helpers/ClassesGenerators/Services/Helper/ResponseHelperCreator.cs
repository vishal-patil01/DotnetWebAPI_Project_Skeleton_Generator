namespace ProjectCreator.Helpers.ClassesGenerators.Services.Helper
{
    public class ResponseHelperCreator
    {
        public static string GetResponseHelperConfiguration(string projectName)
        {
            return @$"using {projectName}.Models.Contracts;
using Microsoft.AspNetCore.Mvc;
using System.Net;

namespace {projectName}.Services.Helpers
{{
